...
* 2번문제
  * 섬을 찾고, 섬에 대해서 bfs를 돌려 각 좌표를 리스트에 넣어둠
  * 이 리스트를 큐로 사용하는 두번째 bfs를 돌려 목적지까지의 최소거리를 구함
...
* 3차원 visited 배열을 사용함
  * visited 배열의 차원을 낮추는 단계에서 조건을 거는 것과 어느 차원의 visited 배열을 참고해 +1 해야하는지에대해 고민이 있었음
